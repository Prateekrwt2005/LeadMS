      ...
      <header className="flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div>
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-500">
            Products currently available in your sales
            catalog.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3 sm:flex-row">
          ...
          <div className="relative flex-1">
            ...
            <input
              ...
              className="w-full rounded-xl border border-white/10 bg-[#050505] py-3 pl-10 pr-4 text-sm text-white outline-none transition duration-200 placeholder:text-slate-700 hover:border-white/15 focus:border-white/20 focus:bg-white/[0.02] focus:ring-2 focus:ring-white/5"
            />
          ...
          {filteredProducts.map((product) => {
            ...
            return (
              ...
              >
                ...
                <div className="pointer-events-none absolute -right-16 -top-16 h-40 w-40 rounded-full bg-white/[0.025] blur-3xl transition duration-500 group-hover:bg-white/[0.07]" />
                ...
                <button
                  type="button"
                  onClick={() =>
                    handleUnlock(product._id)
                  }
                  disabled={isUnlocking}
                  className="relative mt-5 w-full rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3 text-sm font-semibold text-slate-300 transition duration-200 hover:border-red-500/30 hover:bg-red-500/5 hover:text-red-300 active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-50"
                >
                  {isUnlocking ? (
                    <span className="inline-flex items-center gap-2">
                      <span className="h-3.5 w-3.5 animate-spin rounded-full border-2 border-slate-600 border-t-white" />
                      Unlocking...
                    </span>
                  ) : (
                    <span className="inline-flex items-center gap-2">
